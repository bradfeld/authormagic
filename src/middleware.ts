...
function addSecurityHeaders(
  ...
  const csp = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://*.clerk.com https://*.clerk.accounts.dev https://js.clerk.com https://clerk.com https://clerk.authormagic.com https://www.google.com https://www.gstatic.com https://www.recaptcha.net https://vercel.live",
    'worker-src blob:',
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
    "font-src 'self' https://fonts.gstatic.com",
    "img-src 'self' data: https: blob:",
    "connect-src 'self' https://*.clerk.com https://*.clerk.accounts.dev https://api.clerk.com https://clerk.com https://clerk.authormagic.com https://www.google.com https://www.recaptcha.net https://api2.isbndb.com https://www.googleapis.com https://vercel.live wss://ws-us3.pusher.com",
    "frame-src 'self' https://*.clerk.com https://*.clerk.accounts.dev https://js.clerk.com https://clerk.com https://clerk.authormagic.com https://www.google.com https://www.recaptcha.net https://recaptcha.google.com https://vercel.live",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
